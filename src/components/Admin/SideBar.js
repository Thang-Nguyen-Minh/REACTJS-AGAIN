            ...
            >
                    ...
                    >
                        <div className="logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="4rem" height="4rem" fill="none" viewBox="0 0 602 602">
                                <g>
                                    <path stroke="#E91E63" stroke-miterlimit="10"
                                          stroke-width="24"
                ...
                <SidebarContent>
                    <Menu iconShape="circle">
                        ...
                        >
                            Dashboard
                            <Link to='/admin' element={<DashBoard/>}/>
                        </MenuItem>
                    </Menu>
                    <Menu iconShape="circle">
                        <SubMenu
                        ...
                        >
                            <MenuItem>
                                Quản lý Users
                                <Link to='/admin/manage-user' element={<ManageUser/>}/>
                            </MenuItem>
                ...
                <SidebarFooter style={{ textAlign: 'center' }}>
                    ...
                    >
                        <a
                            href="https://github.com/Thang-Nguyen-Minh/REACTJS"
                            target="_blank"
